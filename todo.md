...
## המרחלה 21: רפורמה גדולה - Agency Operating System
- [ ] Phase 1: שדרוג Dashboard - Today Focus + Campaign Overview + Alerts + Quick Actions
- [ ] Phase 2: שדרוג Clients Module - filters, search, sorting
- [ ] Phase 3: יצירת Client Profile Page - 6 tabs (Overview, Campaigns, Tasks, Strategy, Invoices, Timeline)
- [ ] Phase 4: שדרוג Campaigns Module - filters ודטיילים מורחבים
- [ ] Phase 5: יצירת Tasks Kanban Board - drag & drop, 4 columns (To Do, In Progress, Review, Done)
- [ ] Phase 6: יצירת AI Center Hub - 5 כלים AI (Client Analysis, Campaign Strategy, Ad Copy, Performance, Task Generator)
- [ ] Phase 7: שדרוג Reports - AI generation + weekly/monthly reports
- [ ] Phase 8: Polish UX - micro-interactions, empty states, loading states, responsive design
- [ ] KPI Enhancement - % שינוי חודשי, YoY %, הכנסות רבעוני, QoQ %, PDF export (משימה לאחר הרפורמה)
