...
- [x] בדוק וסדר טופס הצוות - תיקון RTL number parsing
- [x] בדוק וסדר טופס הכספים - תיקון RTL number parsing (הכנסות/הוצאות)
- [x] בדוק וסדר טופס המשימות
- [x] וודא שכל הטפסים שומרים נכון למסד הנתונים
- [x] הוסף RTL number parsing utility (parseRTLNumber, isValidNumber)
- [x] תיקון error messages - הצגת הודעות שגיאה ממשיות במקום "error"
